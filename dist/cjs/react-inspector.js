...
var base = (function (theme) {
  return {
    ...
    TreeNode: {
      ...
      treeNodePlaceholder: _objectSpread2({
        whiteSpace: 'pre',
    ...
    TableInspectorSortIcon: _objectSpread2({
      display: 'block',
      marginRight: 3,
      // 4,
      width: 8,
...
var Arrow = function Arrow(_ref) {
  ...
  return React__default.createElement("span", {
    style: _objectSpread2({}, styles.base, {}, expanded ? styles.expanded : styles.collapsed)
  }, "\u25B6");
};
...
var TreeNode = React.memo(function (props) {
  ...
  }, "\u25B6"), React__default.createElement(NodeRenderer, props)), React__default.createElement("ol", {
    role: "group",
...
var ConnectedTreeNode = React.memo(function (props) {
  ...
  var handleClick = React.useCallback(function () {
    return nodeHasChildNodes && setExpandedPaths(function (prevExpandedPaths) {
      return _objectSpread2({}, prevExpandedPaths, _defineProperty({}, path, !expanded));
    });
...
var ObjectName = function ObjectName(_ref) {
  ...
  var appliedStyles = _objectSpread2({}, themeStyles.base, {}, dimmed ? themeStyles['dimmed'] : {}, {}, styles);
...
var ObjectValue = function ObjectValue(_ref) {
  ...
  var mkStyle = function mkStyle(key) {
    return _objectSpread2({}, themeStyles[key], {}, styles);
  };
...
var DataContainer = function DataContainer(_ref) {
  ...
  return React__default.createElement("div", {
    ...
    return React__default.createElement("tr", {
      ...
      style: _objectSpread2({}, styles.td, {}, borderStyles.none)
      ...
      if (_typeof(rowData) === 'object' && rowData !== null && hasOwnProperty.call(rowData, column)) {
        return React__default.createElement("td", {
          key: column,
          style: _objectSpread2({}, styles.td, {}, borderStyles.solid)
...
var TH = function TH(_ref2) {
  ...
  return React__default.createElement("th", _extends({}, thProps, {
    style: _objectSpread2({}, styles.base, {}, borderStyle, {}, hovered ? styles.base[':hover'] : {}),
